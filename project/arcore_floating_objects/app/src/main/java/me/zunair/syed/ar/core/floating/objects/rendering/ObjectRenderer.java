 ...
 */
package me.zunair.syed.ar.core.floating.objects.rendering;
...
public class ObjectRenderer {
    ...
    public void createOnGlThread(Context context, String objAssetName,
        ...
        final int vertexShader = ShaderUtil.loadGLShader(TAG, context,
                GLES20.GL_VERTEX_SHADER, me.zunair.syed.ar.core.floating.objects.R.raw.object_vertex);
        final int fragmentShader = ShaderUtil.loadGLShader(TAG, context,
                GLES20.GL_FRAGMENT_SHADER, me.zunair.syed.ar.core.floating.objects.R.raw.object_fragment);
