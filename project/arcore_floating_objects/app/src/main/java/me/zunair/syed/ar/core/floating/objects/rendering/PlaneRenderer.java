...
public class PlaneRenderer {
    ...
    public void createOnGlThread(Context context, String gridDistanceTextureName)
        ...
        int vertexShader = ShaderUtil.loadGLShader(TAG, context,
                GLES20.GL_VERTEX_SHADER, me.zunair.syed.ar.core.floating.objects.R.raw.plane_vertex);
        int passthroughShader = ShaderUtil.loadGLShader(TAG, context,
                GLES20.GL_FRAGMENT_SHADER, me.zunair.syed.ar.core.floating.objects.R.raw.plane_fragment);
